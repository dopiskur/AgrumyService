        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypicalCycleDays = table.Column<int>(type: "int", nullable: true),
                    QualityMetricsJson = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDFarmParcel = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    TenantID = table.Column<int>(type: "int", nullable: true),
                    FarmOpenfieldID = table.Column<int>(type: "int", nullable: false),
                    FarmParcelName = table.Column<string>(type: "varchar(120)", maxLength: 120, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDSowing = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    TenantID = table.Column<int>(type: "int", nullable: true),
                    ...
                    Variety = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SeedRateKgPerHa = table.Column<double>(type: "double", nullable: true),
                    ...
                    ClosedUtc = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDZonePlanting = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    TenantID = table.Column<int>(type: "int", nullable: true),
                    ...
                    Notes = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ActiveDeviceFarmUnitZoneID = table.Column<int>(type: "int", nullable: true, computedColumnSql: "(CASE WHEN `Status` = 2 THEN `DeviceFarmUnitZoneID` ELSE NULL END)", stored: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDFarmParcelZone = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    TenantID = table.Column<int>(type: "int", nullable: true),
                    FarmParcelID = table.Column<int>(type: "int", nullable: false),
                    FarmParcelZoneName = table.Column<string>(type: "varchar(120)", maxLength: 120, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsWholeParcel = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false),
                    CurrentSowingID = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDFieldLogEntry = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    TenantID = table.Column<int>(type: "int", nullable: true),
                    SowingID = table.Column<int>(type: "int", nullable: true),
                    FarmParcelZoneID = table.Column<int>(type: "int", nullable: true),
                    ZonePlantingID = table.Column<int>(type: "int", nullable: true),
                    DeviceFarmUnitZoneID = table.Column<int>(type: "int", nullable: true),
                    EntryType = table.Column<int>(type: "int", nullable: false),
                    DateUtc = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: false),
                    CreatedByUserID = table.Column<int>(type: "int", nullable: true),
                    Note = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PayloadJson = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsClosingEntry = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDHarvestResult = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    SowingID = table.Column<int>(type: "int", nullable: true),
                    ZonePlantingID = table.Column<int>(type: "int", nullable: true),
                    FarmParcelZoneID = table.Column<int>(type: "int", nullable: true),
                    DateUtc = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: false),
                    YieldKg = table.Column<double>(type: "double", nullable: false),
                    MoisturePercent = table.Column<double>(type: "double", nullable: true),
                    QualityGrade = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    LossesKg = table.Column<double>(type: "double", nullable: true),
                    MetricsJson = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Note = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SowingID = table.Column<int>(type: "int", nullable: false),
                    FarmParcelZoneID = table.Column<int>(type: "int", nullable: false),
                    AssignedUtc = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: false),
                    ReleasedUtc = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true),
                    ActiveFarmParcelZoneID = table.Column<int>(type: "int", nullable: true, computedColumnSql: "(CASE WHEN `ReleasedUtc` IS NULL THEN `FarmParcelZoneID` ELSE NULL END)", stored: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDFieldLogAttachment = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    FieldLogEntryID = table.Column<int>(type: "int", nullable: false),
