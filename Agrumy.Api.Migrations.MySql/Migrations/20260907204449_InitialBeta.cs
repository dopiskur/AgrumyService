        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActorEmail = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Action = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TargetType = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TargetId = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WaterLevelHysteresis = table.Column<double>(type: "double", nullable: true),
                    TemperatureHysteresis = table.Column<double>(type: "double", nullable: true),
                    HumidityHysteresis = table.Column<double>(type: "double", nullable: true),
                    LightHysteresis = table.Column<double>(type: "double", nullable: true),
                    VentilationIntervalEnabled = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    VentilationInterval = table.Column<int>(type: "int", nullable: true),
                    VentilationIntervalLength = table.Column<int>(type: "int", nullable: true),
                    LightIntervalEnabled = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    LightInterval = table.Column<int>(type: "int", nullable: true),
                    LightIntervalLength = table.Column<int>(type: "int", nullable: true),
                    HeatingIntervalEnabled = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    HeatingInterval = table.Column<int>(type: "int", nullable: true),
                    HeatingIntervalLength = table.Column<int>(type: "int", nullable: true),
                    WaterPumpIntervalEnabled = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    WaterPumpInterval = table.Column<int>(type: "int", nullable: true),
                    WaterPumpIntervalLength = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDDeviceFarm = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    TenantID = table.Column<int>(type: "int", nullable: true),
                    DeviceFarmName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Board = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    FileName = table.Column<string>(type: "varchar(120)", maxLength: 120, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    DateAdded = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true, defaultValueSql: "CURRENT_TIMESTAMP"),
                    FullImageFileName = table.Column<string>(type: "varchar(120)", maxLength: 120, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FullImageUrl = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FullImageSizeBytes = table.Column<long>(type: "bigint", nullable: true),
                    FullImageSha256 = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDDeviceRole = table.Column<int>(type: "int", nullable: false),
                    DeviceRoleName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDDeviceType = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Kit = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ControllerCapable = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    PinoutJson = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ec = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HumidityHysteresis = table.Column<double>(type: "double", nullable: true),
                    LightHysteresis = table.Column<double>(type: "double", nullable: true),
                    BatteryLowThreshold = table.Column<double>(type: "double", nullable: true),
                    BatteryLowHysteresis = table.Column<double>(type: "double", nullable: true),
                    TankRefillThreshold = table.Column<double>(type: "double", nullable: true),
                    TankRefillHysteresis = table.Column<double>(type: "double", nullable: true),
                    WaterPumpMaxRunSeconds = table.Column<int>(type: "int", nullable: true),
                    WaterPumpCooldownSeconds = table.Column<int>(type: "int", nullable: true),
                    EventDedupeMinutes = table.Column<int>(type: "int", nullable: true),
                    ActivationResendCooldownMinutes = table.Column<int>(type: "int", nullable: true),
                    MaxRulesPerZone = table.Column<int>(type: "int", nullable: true),
                    AllowSelfServiceTenantCreation = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    TenantManagementEnabled = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    FirmwareSource = table.Column<int>(type: "int", nullable: false),
                    FirmwareGitHubRepository = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FirmwareCustomRepositoryUrl = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FirmwareRefreshIntervalHours = table.Column<int>(type: "int", nullable: true),
                    FirmwareLastRefreshedAtUtc = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true),
                    SensorDataRetentionDays = table.Column<int>(type: "int", nullable: true),
                    RecycleBinRetentionDays = table.Column<int>(type: "int", nullable: true),
                    PurgeOrphanedSensorDataScheduleEnabled = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    WeatherLocationLat = table.Column<double>(type: "double", nullable: true),
                    WeatherLocationLon = table.Column<double>(type: "double", nullable: true),
                    WeatherPollIntervalMinutes = table.Column<int>(type: "int", nullable: true),
                    WeatherRainSkipThreshold = table.Column<double>(type: "double", nullable: true),
                    ...
                    GatewayMode = table.Column<int>(type: "int", nullable: false),
                    GatewayWaitWindowSeconds = table.Column<int>(type: "int", nullable: false),
                    ProblemEventAlertsEnabled = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ProblemEventExpiryHours = table.Column<int>(type: "int", nullable: false),
                    PasswordMinLength = table.Column<int>(type: "int", nullable: false),
                    PasswordRequireComplexity = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ConfigHeartbeatHours = table.Column<int>(type: "int", nullable: false),
                    MqttTransportEnabled = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    MqttBrokerHost = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MqttBrokerPort = table.Column<int>(type: "int", nullable: false),
                    MqttUsername = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MqttPassword = table.Column<string>(type: "varchar(512)", maxLength: 512, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    EmailUseStartTls = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    EmailUsername = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    EmailPassword = table.Column<string>(type: "varchar(512)", maxLength: 512, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    EmailFromAddress = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    EmailFromName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DevicePinValidMinutes = table.Column<int>(type: "int", nullable: false),
                    ArchiveEnabled = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ArchiveCutoffMode = table.Column<int>(type: "int", nullable: false),
                    ArchiveCustomCutoffDate = table.Column<DateOnly>(type: "date", nullable: true),
                    ArchiveCustomRollingDays = table.Column<int>(type: "int", nullable: true),
                    ArchiveHost = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ArchivePort = table.Column<int>(type: "int", nullable: true),
                    ArchiveDatabaseName = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ArchiveUsername = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ArchivePassword = table.Column<string>(type: "varchar(512)", maxLength: 512, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ArchiveLastRunAtUtc = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ScheduleTimeZone = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Latitude = table.Column<double>(type: "double", nullable: true),
                    Longitude = table.Column<double>(type: "double", nullable: true),
                    EmergencyStopActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    DateCreated = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDTenantWifiConfig = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    TenantID = table.Column<int>(type: "int", nullable: false),
                    Ssid = table.Column<string>(type: "varchar(32)", maxLength: 32, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PwdHash = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PwdSalt = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    BootstrapSecretHash = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    BootstrapSecretSalt = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DevicePin = table.Column<string>(type: "varchar(8)", maxLength: 8, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DevicePinExpires = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true),
                    ...
                    DateCreated = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true, defaultValueSql: "CURRENT_TIMESTAMP"),
                    DateModified = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true, defaultValueSql: "CURRENT_TIMESTAMP"),
                    EmailVerified = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ActivationTokenHash = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ActivationTokenExpiresAt = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true),
                    ActivationLastSentAt = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true),
                    ...
                    TokensValidAfterUtc = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDDeviceFarmUnit = table.Column<int>(type: "int", nullable: false),
                    TenantID = table.Column<int>(type: "int", nullable: true),
                    DeviceFarmUnitName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ZoneEnabled = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    DeviceFarmID = table.Column<int>(type: "int", nullable: true),
                    Deleted = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false),
                    DeletedAtUtc = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_deviceConfigControllerRelay_deviceConfigController_IDDeviceC~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BatteryDividerR1 = table.Column<double>(type: "double", nullable: true),
                    BatteryDividerR2 = table.Column<double>(type: "double", nullable: true),
                    ...
                    SensorEc = table.Column<int>(type: "int", nullable: true),
                    SensorWeight = table.Column<int>(type: "int", nullable: true),
                    WeightCalibrationFactor = table.Column<double>(type: "double", nullable: true),
                    EcCalibrationSlope = table.Column<double>(type: "double", nullable: true),
                    EcCalibrationOffset = table.Column<double>(type: "double", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDDeviceFarmUnitZone = table.Column<int>(type: "int", nullable: false),
                    TenantID = table.Column<int>(type: "int", nullable: true),
                    DeviceFarmUnitID = table.Column<int>(type: "int", nullable: false),
                    DeviceFarmUnitZoneName = table.Column<string>(type: "varchar(120)", maxLength: 120, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Deleted = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false),
                    DeletedAtUtc = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true),
                    WaterPumpMaxRunSeconds = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDDevice = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    TenantID = table.Column<int>(type: "int", nullable: true),
                    DeviceRoleID = table.Column<int>(type: "int", nullable: true),
                    DeviceFarmUnitID = table.Column<int>(type: "int", nullable: true),
                    DeviceFarmUnitZoneID = table.Column<int>(type: "int", nullable: true),
                    ...
                    DeviceName = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MacAddress = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ManualDeviceTypeID = table.Column<int>(type: "int", nullable: true),
                    ...
                    LoRaGatewayEnabled = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    ...
                    FirmwareTargetVersion = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ConfigVersion = table.Column<int>(type: "int", nullable: true),
                    CommandVersion = table.Column<int>(type: "int", nullable: false),
                    DateCreated = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true, defaultValueSql: "CURRENT_TIMESTAMP"),
                    DateModified = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true, defaultValueSql: "CURRENT_TIMESTAMP"),
                    IsGateway = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    GatewayProfile = table.Column<int>(type: "int", nullable: true),
                    LastFullConfigSentAt = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true),
                    LoRaPrivateKeyHex = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDDeviceFarmUnitZoneRule = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    TenantID = table.Column<int>(type: "int", nullable: false),
                    DeviceFarmID = table.Column<int>(type: "int", nullable: true),
                    DeviceFarmUnitID = table.Column<int>(type: "int", nullable: true),
                    ...
                    RelayFunction = table.Column<int>(type: "int", nullable: true),
                    Name = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Description = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RootConditionJson = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsSafetyRule = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    NotificationSubject = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    NotificationBody = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDControllerData = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    DeviceID = table.Column<int>(type: "int", nullable: false),
                    TenantID = table.Column<int>(type: "int", nullable: false),
                    RelayFunction = table.Column<int>(type: "int", nullable: false),
                    IsOn = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    DateChanged = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDDeviceCommand = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    DeviceID = table.Column<int>(type: "int", nullable: false),
                    ActionType = table.Column<int>(type: "int", nullable: false),
                    ...
                    ExpiresAt = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: false),
                    ExecutedAt = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true),
                    ActiveKey = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OfflineNotifiedAt = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true),
                    LowBatteryNotifiedAt = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true),
                    FirmwareVersion = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Board = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DeviceTypeID = table.Column<int>(type: "int", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDReport = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ScanningDeviceID = table.Column<int>(type: "int", nullable: false),
                    DiscoveredApMac = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Rssi = table.Column<int>(type: "int", nullable: true),
                    DateReported = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDDeviceManualOverride = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    DeviceID = table.Column<int>(type: "int", nullable: false),
                    TenantID = table.Column<int>(type: "int", nullable: false),
                    RelayFunction = table.Column<int>(type: "int", nullable: false),
                    ...
                    TargetMetric = table.Column<int>(type: "int", nullable: true),
                    TargetThreshold = table.Column<double>(type: "double", nullable: true),
                    TargetHysteresis = table.Column<double>(type: "double", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDGatewayDeviceMapping = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    IDGatewayDevice = table.Column<int>(type: "int", nullable: false),
                    DevEUI = table.Column<string>(type: "varchar(16)", maxLength: 16, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IDDevice = table.Column<int>(type: "int", nullable: false),
                    DateCreated = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true, defaultValueSql: "CURRENT_TIMESTAMP")
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WaterLevel = table.Column<int>(type: "int", nullable: true),
                    Wind = table.Column<int>(type: "int", nullable: true),
                    Ec = table.Column<double>(type: "double", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "IDDevice");
                    table.ForeignKey(
                        name: "FK_simulationSessionDevice_simulationSession_IDSimulationSession",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IDRuleNotificationState = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    RuleID = table.Column<int>(type: "int", nullable: false),
                    DeviceFarmUnitZoneID = table.Column<int>(type: "int", nullable: false),
                    WasTrue = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    LastFiredAtUtc = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
