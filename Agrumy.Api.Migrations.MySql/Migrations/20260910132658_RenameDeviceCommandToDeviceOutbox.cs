...
{
    /// <inheritdoc />
    // Hand-edited after scaffolding - the raw scaffold was a DropTable+CreateTable (data loss on
    // every pending/historical deviceCommand row on invent.hr); rewritten as Rename*/AddColumn so
    // existing rows survive with their IDs/values intact.
