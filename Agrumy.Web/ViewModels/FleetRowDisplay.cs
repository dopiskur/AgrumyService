...
namespace Agrumy.Web.ViewModels
{
    ...
    public static class FleetRowDisplay
    {
        ...
        // Disabled devices keep a mostly-white badge with a colored stripe carrying the underlying state's color - full-saturation, not "-subtle", or it's invisible at a 5% stripe width.
