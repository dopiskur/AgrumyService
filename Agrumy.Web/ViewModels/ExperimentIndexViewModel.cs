...
{
    /// Drives Experiment/Index.cshtml's Create form - Farms/Units/Zones/Arables/Parcels back the per-scope dropdown (a name, not a raw id the admin would otherwise have to type/know).
    public class ExperimentIndexViewModel
    {
        ...
        public required IList<Sowing> Arables { get; init; }
        public required IList<ParcelOption> Parcels { get; init; }
    }

    /// Same "Farm / Arable name" grouped-label convention as ZoneOption, for the Open-Field branch.
