...
{
    /// Builds an SVG &lt;polyline&gt; points attribute from a 24-bucket trend array, no charting library needed for a widget this small. Null buckets (no reading that hour) are simply skipped, leaving a gap rather than interpolating a fake value.
