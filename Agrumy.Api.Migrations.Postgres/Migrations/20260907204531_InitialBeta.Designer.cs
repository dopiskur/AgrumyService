...
namespace Agrumy.Api.Migrations.Postgres.Migrations
{
    ...
    [Migration("20260907204531_InitialBeta")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Dal.Entities.AuditLogRow", b =>
                {
            ...
            modelBuilder.Entity("api.Dal.Entities.ControllerDataRow", b =>
                {
            ...
            modelBuilder.Entity("api.Dal.Entities.DeviceCommandRow", b =>
                {
            ...
            modelBuilder.Entity("api.Dal.Entities.DeviceConfigControllerRelayRow", b =>
                {
            ...
            modelBuilder.Entity("api.Dal.Entities.DeviceDiagnosticRow", b =>
                {
                    b.Property<int>("DeviceID")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("api.Dal.Entities.DeviceDiscoveryReportRow", b =>
                {
            ...
            modelBuilder.Entity("api.Dal.Entities.DeviceFarmRow", b =>
                {
            ...
            modelBuilder.Entity("api.Dal.Entities.DeviceFarmUnitRow", b =>
                {
            ...
            modelBuilder.Entity("api.Dal.Entities.DeviceFarmUnitZoneRow", b =>
                {
            ...
            modelBuilder.Entity("api.Dal.Entities.DeviceFarmUnitZoneRuleRow", b =>
                {
            ...
            modelBuilder.Entity("api.Dal.Entities.DeviceManualOverrideRow", b =>
                {
            ...
            modelBuilder.Entity("api.Dal.Entities.DeviceRoleRow", b =>
                {
            ...
            modelBuilder.Entity("api.Dal.Entities.DeviceScheduleSlotRow", b =>
                {
            ...
            modelBuilder.Entity("api.Dal.Entities.DeviceSimulationRow", b =>
                {
                    b.Property<int>("DeviceID")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("api.Dal.Entities.DeviceVirtualRow", b =>
                {
                    b.Property<int>("DeviceID")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("api.Dal.Entities.EventTypeRow", b =>
                {
            ...
            modelBuilder.Entity("api.Dal.Entities.GatewayDeviceMappingRow", b =>
                {
            ...
            modelBuilder.Entity("api.Dal.Entities.RefreshTokenRow", b =>
                {
            ...
            modelBuilder.Entity("api.Dal.Entities.RuleNotificationStateRow", b =>
                {
            ...
            modelBuilder.Entity("api.Dal.Entities.SimulationSessionDeviceRow", b =>
                {
            ...
            modelBuilder.Entity("api.Dal.Entities.SimulationSessionRow", b =>
                {
                    b.Property<int>("IDSimulationSession")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("api.Dal.Entities.TenantWifiConfigRow", b =>
                {
            ...
            modelBuilder.Entity("api.Dal.Entities.UserUserRoleRow", b =>
                {
                    b.Property<int>("UserID")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("api.Dal.Entities.DeviceFarmUnitRow", b =>
                {
                    b.HasOne("api.Dal.Entities.DeviceFarmRow", null)
                        .WithMany()
            ...
            modelBuilder.Entity("api.Dal.Entities.DeviceFarmUnitZoneRow", b =>
                {
                    b.HasOne("api.Dal.Entities.DeviceFarmUnitRow", null)
                        .WithMany()
            ...
            modelBuilder.Entity("api.Dal.Entities.DeviceFarmUnitZoneRuleRow", b =>
                {
                    ...
                    b.HasOne("api.Dal.Entities.DeviceFarmUnitZoneRow", null)
                        .WithMany()
            ...
            modelBuilder.Entity("api.Dal.Entities.DeviceRow", b =>
                {
                    ...
                    b.HasOne("api.Dal.Entities.DeviceRoleRow", null)
                        .WithMany()
            ...
            modelBuilder.Entity("api.Dal.Entities.EventDeviceRow", b =>
                {
                    b.HasOne("api.Dal.Entities.EventTypeRow", null)
                        .WithMany()
            ...
            modelBuilder.Entity("api.Dal.Entities.RefreshTokenRow", b =>
                {
                    b.HasOne("api.Dal.Entities.UserRow", null)
                        .WithMany()
            ...
            modelBuilder.Entity("api.Dal.Entities.RuleNotificationStateRow", b =>
                {
                    ...
                    b.HasOne("api.Dal.Entities.DeviceFarmUnitZoneRuleRow", null)
                        .WithMany()
            ...
            modelBuilder.Entity("api.Dal.Entities.SimulationSessionDeviceRow", b =>
                {
                    ...
                    b.HasOne("api.Dal.Entities.SimulationSessionRow", null)
                        .WithMany()
