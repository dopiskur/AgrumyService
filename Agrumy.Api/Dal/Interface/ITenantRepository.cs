...
namespace Agrumy.Api.Dal.Interface
{
    ...
    public interface ITenantRepository
    {
        ...
        /// The only writer of Tenant.EmergencyStopActive - also bumps ConfigVersion for every device in the tenant so the change reaches them on their next poll rather than waiting for the heartbeat window.
