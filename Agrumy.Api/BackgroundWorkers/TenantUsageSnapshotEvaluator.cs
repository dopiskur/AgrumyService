...
{
    /// Records one usage snapshot per tenant per day, kept separate from TenantUsageSnapshotBackgroundService so it is directly unit-testable with a mocked repository.
