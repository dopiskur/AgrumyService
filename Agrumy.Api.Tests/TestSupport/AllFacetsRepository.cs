...
namespace Agrumy.Api.Tests.TestSupport
{
    ...
    internal sealed partial class AllFacetsRepository(AgrumyDbContext db, IAuditLogRepository auditLogRepository, IRefreshTokenRepository refreshTokenRepository, IControllerDataRepository controllerDataRepository, IDiscoveryRepository discoveryRepository, ITenantRepository tenantRepository, IGatewayRepository gatewayRepository, IServerConfigRepository serverConfigRepository, IDeviceOutboxRepository outboxRepository, IFirmwareRepository firmwareRepository, IUserRepository userRepository, IDeviceRepository deviceRepository, ISimulationRepository simulationRepository, IDeviceFarmUnitRepository deviceFarmUnitRepository, ISensorDataRepository sensorDataRepository, IExperimentRepository experimentRepository, ICropCatalogEntryRepository cropCatalogEntryRepository, ISowingRepository sowingRepository, IFarmParcelRepository farmParcelRepository, ICropCatalogRepository cropCatalogRepository, IFieldLogRepository fieldLogRepository, IZonePlantingRepository zonePlantingRepository, ISatelliteConfigRepository satelliteConfigRepository, ISatelliteSceneRepository satelliteSceneRepository, IFarmGroupRepository farmGroupRepository) :
        ...
        IExperimentRepository, ICropCatalogEntryRepository, ISowingRepository, IFarmParcelRepository, ICropCatalogRepository, IFieldLogRepository, IZonePlantingRepository,
        ISatelliteConfigRepository, ISatelliteSceneRepository, IFarmGroupRepository
    {
