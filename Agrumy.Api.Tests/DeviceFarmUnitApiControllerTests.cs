...
public class DeviceFarmUnitApiControllerTests
{
    ...
    {
        var controller = new DeviceFarmUnitApiController(_repo.Object, _repo.Object, _repo.Object, _repo.Object, _repo.Object, _repo.Object, _repo.Object, _repo.Object, _repo.Object, _repo.Object, _cache.Object,
            Options.Create(new AgrumySettings()), new ManualActuateService(_repo.Object, _repo.Object),
            new DeviceOutboxService(_repo.Object, _repo.Object, _repo.Object, _repo.Object, new NoOpMqttCommandPublisher()),
            new Agrumy.Api.Quota.TenantQuotaEnforcer(_repo.Object, _repo.Object, _repo.Object, _repo.Object, _repo.Object, _repo.Object, _repo.Object),
    ...
    public async Task DeviceFarmUnitZoneWidgetsSet_Valid_SavesAndAudits()
    {
        ...
        var widgets = new List<DashboardWidget> { new() { Type = DashboardWidgetType.SensorValue, Metric = SensorMetric.Temperature, AggregationLevel = HierarchyNodeKind.Zone, LevelID = 7 } };
    ...
    public async Task DeviceFarmUnitZoneWidgetsSet_SensorWidgetTargetsForeignTenantFarm_Returns400_NeverSaves()
    {
        ...
        var controller = NewController();
        SetCaller(controller, 1, "user", RoleNames.TenantAdmin);
        var widgets = new List<DashboardWidget> { new() { Type = DashboardWidgetType.SensorValue, Metric = SensorMetric.Temperature, AggregationLevel = HierarchyNodeKind.Farm, LevelID = 3 } };
    ...
    public async Task DashboardWidgetAggregateGet_OwnedFarm_ReturnsAggregate()
    {
        ...
        _repo.Setup(r => r.DashboardAggregateGetAsync(HierarchyNodeKind.Farm, 3)).ReturnsAsync(aggregate);
        var controller = NewController();
        SetCaller(controller, 1, "user", RoleNames.TenantAdmin);
